...
| ------ | ------ | ------ |
| Shop Admin | A single payload both populates datastore and queries suppliers, products, customers and orders. (PHP, Cloudfalre Worker, Deno Deploy, Netlify). This is our "Hello World" App  | [apps/shopadmin](../../../apps/tree/main/shopadmin) |
